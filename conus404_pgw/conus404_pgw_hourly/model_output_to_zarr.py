...
from ..conus404_helpers import (apply_metadata, build_hourly_filelist, delete_dir, get_accum_types,
                                read_metadata, rechunker_wrapper)
from ..conus404_maths import solar_radiation_acc
...
def to_zarr(chunk_index: int,
    ...
    for sol_var, bucket_var in solrad_vars.items():
        ds_src[sol_var] = solar_radiation_acc(ds_src[sol_var], ds_src[bucket_var])
